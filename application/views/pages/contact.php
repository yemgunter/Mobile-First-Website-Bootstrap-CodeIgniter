    ...
    <div class="row">
        <form id="email-form" name="emailform" action="contact" method="post">
            <div class="form-group">
                <input type="text" class="form-control" id="name" name="name" placeholder="Name" maxlength="64" value="">
                ...
                <textarea class="form-control" id="message" name="message" placeholder="Enter Message" maxlength="1000" ></textarea>
            </div>
            <div class="form-group">
